"""Test alpenhorn.client.options"""

import click
import pytest
from alpenhorn.client.options import set_io_config
...
def test_sic_iovar_no_equals(clidb, client):
...
def test_create_iovar_equals_equals(clidb, client):
