...
def test_acq_not_found(clidb, client):
    ...
    client(1, ["acq", "show", "Acq"])


def test_simple_show(clidb, client):
...
def test_show_no_nodes(clidb, client):
...
def test_show_no_groups(clidb, client):
