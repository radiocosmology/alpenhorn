...
def test_copy_check_delete_arcount(
    ...
    arc1 = storagenode(name="arc1", group=simplegroup, storage_type="A")
    arc2 = storagenode(name="arc2", group=simplegroup, storage_type="A")

    # This is the node we're deleting from
    node = storagenode(name="node", group=simplegroup, storage_type="F")
...
def test_copy_check_delete_from_arc(
    ...
    # This is the node we're deleting from
    node = storagenode(name="node", group=simplegroup, storage_type="A")
...
def test_copy_check_delete_arcount_config(
    ...
    arc1 = storagenode(name="arc1", group=simplegroup, storage_type="A")
    arc2 = storagenode(name="arc2", group=simplegroup, storage_type="A")
    arc3 = storagenode(name="arc3", group=simplegroup, storage_type="A")
