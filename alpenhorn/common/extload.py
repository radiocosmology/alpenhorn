"""``alpenhorn.common.extload``: Alpenhorn extension loader.
...
def import_detection() -> list[extapi.ImportDetectExtension]:
    """Return the list of registered import-detect extensions.
...
def io_extension(name: str) -> extapi.IOClassExtension | InternalIO | None:
    """Return the Extension providing the I/O class named `name`.
